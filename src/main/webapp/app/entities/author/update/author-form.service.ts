...
type AuthorFormGroupContent = {
  ...
  nameAuthor: FormControl<IAuthor['nameAuthor']>;
  surnameAuthor: FormControl<IAuthor['surnameAuthor']>;
};
...
export class AuthorFormService {
  createAuthorFormGroup(author: AuthorFormGroupInput = { id: null }): AuthorFormGroup {
    ...
    return new FormGroup<AuthorFormGroupContent>({
      ...
      nameAuthor: new FormControl(authorRawValue.nameAuthor),
      surnameAuthor: new FormControl(authorRawValue.surnameAuthor),
    });
  }
