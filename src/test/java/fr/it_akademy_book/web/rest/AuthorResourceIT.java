...
class AuthorResourceIT {
    ...
    private static final String DEFAULT_NAME_AUTHOR = "AAAAAAAAAA";
    private static final String UPDATED_NAME_AUTHOR = "BBBBBBBBBB";

    private static final String DEFAULT_SURNAME_AUTHOR = "AAAAAAAAAA";
    private static final String UPDATED_SURNAME_AUTHOR = "BBBBBBBBBB";
    ...
    public static Author createEntity(EntityManager em) {
        Author author = new Author().nameAuthor(DEFAULT_NAME_AUTHOR).surnameAuthor(DEFAULT_SURNAME_AUTHOR);
        return author;
    }
    ...
    public static Author createUpdatedEntity(EntityManager em) {
        Author author = new Author().nameAuthor(UPDATED_NAME_AUTHOR).surnameAuthor(UPDATED_SURNAME_AUTHOR);
        return author;
    }
    ...
    void createAuthor() throws Exception {
        ...
        assertThat(testAuthor.getNameAuthor()).isEqualTo(DEFAULT_NAME_AUTHOR);
        assertThat(testAuthor.getSurnameAuthor()).isEqualTo(DEFAULT_SURNAME_AUTHOR);
    }
    ...
    void getAllAuthors() throws Exception {
        ...
        restAuthorMockMvc
            ...
            .andExpect(jsonPath("$.[*].nameAuthor").value(hasItem(DEFAULT_NAME_AUTHOR)))
            .andExpect(jsonPath("$.[*].surnameAuthor").value(hasItem(DEFAULT_SURNAME_AUTHOR)));
    }
    ...
    void getAuthor() throws Exception {
        ...
        restAuthorMockMvc
            ...
            .andExpect(jsonPath("$.nameAuthor").value(DEFAULT_NAME_AUTHOR))
            .andExpect(jsonPath("$.surnameAuthor").value(DEFAULT_SURNAME_AUTHOR));
    }
    ...
    void putExistingAuthor() throws Exception {
        ...
        updatedAuthor.nameAuthor(UPDATED_NAME_AUTHOR).surnameAuthor(UPDATED_SURNAME_AUTHOR);
        ...
        Author testAuthor = authorList.get(authorList.size() - 1);
        assertThat(testAuthor.getNameAuthor()).isEqualTo(UPDATED_NAME_AUTHOR);
        assertThat(testAuthor.getSurnameAuthor()).isEqualTo(UPDATED_SURNAME_AUTHOR);
    }
    ...
    void fullUpdateAuthorWithPatch() throws Exception {
        ...
        partialUpdatedAuthor.nameAuthor(UPDATED_NAME_AUTHOR).surnameAuthor(UPDATED_SURNAME_AUTHOR);
